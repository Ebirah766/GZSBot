...
"New York Aquarium": "1.0"
    ...
    "Domestic Chicken": {
        ...
        "info": "One of the most well-known species of beetles, the Japanese rhinoceros beetle is found in Asia, from India to Japan. Adults feed on tree sap and bore through the wood to get to it. Males use their large horns to fight each other for mates or        "type": "Invertebrate",
        "order": "Coleoptera",
        "family": "Scarabaeidae",
        "genus": "Allomyrina",
